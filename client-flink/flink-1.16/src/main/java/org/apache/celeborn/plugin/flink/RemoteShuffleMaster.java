...
public class RemoteShuffleMaster implements ShuffleMaster<ShuffleDescriptor> {
  ...
  public RemoteShuffleMaster(
    ...
    this.delegation =
        new RemoteShuffleMasterDelegation(shuffleMasterContext, nettyShuffleServiceFactory);
  }
  ...
  public LifecycleManager lifecycleManager() {
    return delegation.lifecycleManager();
  }

  public ConcurrentHashMap<JobID, String> jobFallbackPolicies() {
    return delegation.jobFallbackPolicies();
  }
}
